...
//        $this->load->controller("airports/airports"); //don't work - problem with session
        Myth\modules::load_file( 'Airports', APPPATH.'Modules/airports/controllers/');  // get the include() file
        $this->airports = new Airports(true);   //skip inherited contructors so that we use current controller context *ie: cows)
 
        $this->airports->index();   //call airports module index method
